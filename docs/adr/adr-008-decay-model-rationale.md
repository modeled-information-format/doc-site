...
- [ADR-001: Cognitive Triad Taxonomy](/docs/adr/adr-001-cognitive-triad-taxonomy/) — default decay half-lives differ by base type (semantic, episodic, procedural).
- [ADR-009: OKF Compliance as a Superset](/docs/adr/adr-009-okf-compliance-superset/) — decay/validity is MIF's answer to OKF's open stale-vs-live question; this ADR is one row of the "MIF answers OKF's open questions" table.
