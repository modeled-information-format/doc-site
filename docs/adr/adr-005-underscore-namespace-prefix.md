---
title: "ADR-005: Underscore Namespace Prefix Convention"
---
...
- [ADR-001](adr-001-cognitive-triad-taxonomy) - Prefix convention derives from the three base memory types
- [ADR-003](adr-003-obsidian-compatibility) - Underscore prefix ensures filesystem compatibility with Obsidian vaults
