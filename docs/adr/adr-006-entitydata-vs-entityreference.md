---
title: "ADR-006: EntityData vs EntityReference"
---
...
- [ADR-004](adr-004-three-tier-trait-inheritance) - Trait inheritance model governs EntityData schema composition
- [ADR-002](adr-002-dual-format-design) - Both entity patterns have dual format (Markdown/JSON-LD) representations
