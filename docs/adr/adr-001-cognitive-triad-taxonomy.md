...
related:
  ...
  - /docs/adr/adr-004-three-tier-trait-inheritance/
...
- [ADR-005: Underscore Namespace Prefix](/docs/adr/adr-005-underscore-namespace-prefix/) — the namespace prefix convention derives from the three base memory types.
- [ADR-008: Decay Model Rationale](/docs/adr/adr-008-decay-model-rationale/) — default decay half-lives vary by base memory type.
- [ADR-004: Three-Tier Trait Inheritance](/docs/adr/adr-004-three-tier-trait-inheritance/) — traits absorb memories that span more than one base type.
- [ADR-009: OKF Compliance as a Superset](/docs/adr/adr-009-okf-compliance-superset/) — this base-type taxonomy is MIF's answer to OKF's deliberately-absent concept-type system.
