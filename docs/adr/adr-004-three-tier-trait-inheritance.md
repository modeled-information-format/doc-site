---
title: "ADR-004: Three-Tier Trait Inheritance"
---
...
- [ADR-006](adr-006-entitydata-vs-entityreference) - EntityData ties into the trait system for structured entity representation
- [ADR-001](adr-001-cognitive-triad-taxonomy) - Three base memory types form the foundation that traits extend
