---
title: "ADR-002: Dual Format Design (Markdown + JSON-LD)"
---
...
- [ADR-003](adr-003-obsidian-compatibility) - Markdown format is designed for Obsidian compatibility
- [ADR-007](adr-007-github-raw-urls-for-schema-ids) - JSON-LD format requires resolvable schema $id URIs
