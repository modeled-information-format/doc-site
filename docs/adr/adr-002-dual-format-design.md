...
- [ADR-003: Obsidian Compatibility](/docs/adr/adr-003-obsidian-compatibility/) — the Markdown format is designed to be valid Obsidian notes, which is the constraint that makes Markdown the natural human-authoring surface here.
