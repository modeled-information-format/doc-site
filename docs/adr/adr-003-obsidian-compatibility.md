---
title: "ADR-003: Obsidian Compatibility"
---
...
- [ADR-002](adr-002-dual-format-design) - Obsidian is one of the dual formats supported by MIF
- [ADR-005](adr-005-underscore-namespace-prefix) - Underscore prefix convention ensures filesystem compatibility with Obsidian vaults
