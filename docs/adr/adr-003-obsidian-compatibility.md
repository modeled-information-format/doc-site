...
- [ADR-002: Dual Format Design](/docs/adr/adr-002-dual-format-design/) — Obsidian-compatible Markdown is one of the two formats MIF maintains; this ADR profiles that Markdown half.
- [ADR-005: Underscore Namespace Prefix](/docs/adr/adr-005-underscore-namespace-prefix/) — the underscore-prefix convention ensures the folder-as-namespace mapping is filesystem-compatible with Obsidian vaults.
