...
- [ADR-009: OKF Compliance as a Superset (Pinned OKF v0.1)](/docs/adr/adr-009-okf-compliance-superset/) — builds on the independent, domain-neutral identity that this repositioning establishes.
- [ADR-001: Cognitive Triad Taxonomy](/docs/adr/adr-001-cognitive-triad-taxonomy/) — the semantic/episodic/procedural taxonomy becomes the base content model on which the AI-memory profile sits.
