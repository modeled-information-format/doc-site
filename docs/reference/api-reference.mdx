---
title: "API Reference"
description: "REST API reference for MIF-compatible memory services."
---
...
**Location:** `https://mif-spec.dev/schema/context.jsonld`
...
- [Migration Guide](/docs/how-to/migration/)
