...
|--------|---------|----------|
| `mif.schema.json` | Complete MIF document validation | `https://mif-spec.dev/schema/mif.schema.json` |
| `citation.schema.json` | Standalone citation validation | `https://mif-spec.dev/schema/citation.schema.json` |
| `ontology.schema.json` | Ontology definition validation | `https://mif-spec.dev/schema/ontology/ontology.schema.json` |
...
These values are pragmatic defaults inspired by Ebbinghaus's forgetting curve research, adapted for AI memory systems. See the [MIF Specification](https://mif-spec.dev/specification/overview/) for detailed rationale and scientific background.
...
npx ajv validate -s https://mif-spec.dev/schema/mif.schema.json -d memory.json

# Validate with verbose output
npx ajv validate -s https://mif-spec.dev/schema/mif.schema.json -d memory.json --verbose

# Validate multiple files
npx ajv validate -s https://mif-spec.dev/schema/mif.schema.json -d "memories/*.json"
```
