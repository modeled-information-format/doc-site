...
These values are pragmatic validity/freshness defaults. The cognitive-memory rationale for tuning them lives in the AI Memory profile. See the [Specification](https://mif-spec.dev/specification/overview/) for detailed rationale.
